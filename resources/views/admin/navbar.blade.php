        ...
        <div class="navbar-container">
            ...
            <div class="user-container">
                <div class="relative dropdown-button-border">
                    ...
                    <button id="themeToggle" class="dropdown-button sidebar-link">
                ...
                <div class="relative">
                    <!-- Dropdown -->
                    <button id="userDropdownButton" class="dropdown-button sidebar-link">
                        Usuário
                    ...
                    <div id="dropdownContent" class="dropdown-content hidden">
                        <a href="{{ route('profile.show') }}" class="dropdown-item sidebar-link">Perfil</a>
                        <a href="{{ route('logout') }}" class="dropdown-item sidebar-link">Sair</a>
                    </div>
                </div>
            </div>
        </div>
