    ...
    <div class="content-wrapper">
        <div class="content-header">
            ...
            <nav class="breadcrumb">
                ...
                <span>/</span>
                <a href="{{ route('categories.index') }}" class="breadcrumb-link">Usuários</a>
                <span>/</span>
                <span>Detalhes</span>
            </nav>
        </div>
    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('edit-category')
                    <a href="{{ route('categories.edit', $category) }}" class="btn-warning align-icon-btn">
                ...
                @can('destroy-category')
                    <form id="delete-form-{{ $category->id }}" action="{{ route('categories.destroy', $category) }}" method="POST">
                        ...
                        @method('delete')
                            ...
                            <button type="button" onclick="confirmDelete('{{ $category->id }}')" class="btn-danger flex items-center space-x-1">
        ...
        <div class="detail-box">
            ...
            <div class="mb-1">
                ...
                <span class="detail-content">{{ $category->id }}</span>
            </div>
            ...
            <div class="mb-1">
                ...
                <span class="detail-content">{{ $category->slug }}</span>
            </div>

            <div class="mb-1">
                <span class="title-detail-content">Status: </span>
                <span class="detail-content">{{ $category->active == 1 ? 'Ativo' : 'Inativo' }} </span>
            </div>

            <div class="mb-1">
                <span class="title-detail-content">Cadastrado: </span>
                <span class="detail-content">{{ \Carbon\Carbon::parse($category->created_at)->format('d/m/Y H:i:s') }}</span>
            </div>

            <div class="mb-1">
                <span class="title-detail-content">Editado: </span>
                <span class="detail-content">{{ \Carbon\Carbon::parse($category->updated_at)->format('d/m/Y H:i:s') }}</span>
            </div>
