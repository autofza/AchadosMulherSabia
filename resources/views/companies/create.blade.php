...
<div class="content-box">
    ...
    <form action="{{ route('companies.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" id="name" class="form-input" placeholder="Descrição da Empresa" value="{{ old('name') }}" required>
        </div>

        <!-- Link -->
        <div class="mb-4">
            <label for="link" class="form-label">Link do Site</label>
            <input type="text" name="link" id="link" class="form-input" placeholder="O link do Site" value="{{ old('link') }}" required>
        </div>

        <!-- Imagem -->
        <div class="mb-4">
            <label for="soon" class="form-label">Logo</label>
