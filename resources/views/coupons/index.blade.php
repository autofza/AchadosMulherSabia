                    ...
                    @forelse ($coupons as $coupon)
                        <tr class="table-row-body">
                            ...
                            <td class="table-body text-center">
                                <a href="#"
                                    onclick="event.preventDefault(); document.getElementById('toggle-{{ $coupon->id }}').submit();"
                                    ...
                                    @else
                                        <!-- Ícone de X (vermelho) -->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="w-5 h-5 text-red-500 hover:text-red-600 transition-colors" fill="none"
                                ...
                                <form id="toggle-{{ $coupon->id }}" action="{{ route('coupons.toggle', $coupon->id) }}"
                            ...
                            <td class="table-actions">
                                <div class="table-actions-align">
                                    ...
                                    @if ($isActive)
                                        <a href="{{ route('coupons.byCompany', $coupon->company->id) }}"
                                            class="btn-success flex items-center space-x-1">
                                        @else
                                            <span
                                                class="btn-warning flex items-center space-x-1 opacity-50 cursor-not-allowed"
                                                aria-disabled="true">
                                    @endif
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="size-5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M9 15.75h6m-6-3H15m-6-3h6m6-1.5A2.25 2.25 0 0 1 18.75 6h-13.5A2.25 2.25 0 0 1 3 8.25v7.5A2.25 2.25 0 0 1 5.25 18h13.5A2.25 2.25 0 0 1 21 15.75v-7.5Z" />
                                    </svg>
